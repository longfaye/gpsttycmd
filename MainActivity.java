...
public class MainActivity extends ActionBarActivity {
	...
	byte[] bttest = {(byte) 0x81,(byte) 0x88,0x63,(byte) 0xfe,(byte) 0xee,0x03,0x30,0x33,0x3};	
	...
	public void BTRMC(View v) {
		...
		if (bl1) {
			 ...
			 * 
			 */
			//ShellCmd.exec("/system/bin/gpstty "+"\""+btifmodecmdoff+"\"");
			//ShellCmd.exec("/system/bin/gpstty "+"\""+btrmccmd0+"\"");
			//ShellCmd.exec("/system/bin/gpstty "+"\""+btifmodecmdon+"\"");
			 ...
			 */
			//ShellCmd.exec("/system/bin/gpstty "+"\""+btifmodecmdoff+"\"");
			//ShellCmd.exec("/system/bin/gpstty "+"\""+btrmccmd1+"\"");
			//ShellCmd.exec("/system/bin/gpstty "+"\""+btifmodecmdon+"\"");
